...
plot_run_data(run_dir_per[0], per_color, per_linestyle, run_dir_per[1])
plot_run_data(run_dir_uniform[0], uniform_color, uniform_linestyle, run_dir_uniform[1])
...
save_path = base_path + "/plots/buffer_comparison.png"
