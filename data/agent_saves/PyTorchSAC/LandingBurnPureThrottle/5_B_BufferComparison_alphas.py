...
run_dir_per = ("5_A_PER_2500", r"PER: $\alpha = 0.6$")
run_dir_per_2 = ("6_A_alphaper", r"PER: $\alpha = 0.7$")
run_dir_per_3 = ("6_B_alphaper", r"PER: $\alpha = 0.5$")
run_dir_uniform = ("5_A_Uniform_2000", r"Uniform")
...
plot_run_data(run_dir_per[0], 'blue', '-', run_dir_per[1])
plot_run_data(run_dir_per_2[0], 'green', '-', run_dir_per_2[1])
plot_run_data(run_dir_per_3[0], 'purple', '-', run_dir_per_3[1])
plot_run_data(run_dir_uniform[0], 'red', '-', run_dir_uniform[1])
...
save_path = base_path + "/plots/buffer_comparison_per_alphas.png"
