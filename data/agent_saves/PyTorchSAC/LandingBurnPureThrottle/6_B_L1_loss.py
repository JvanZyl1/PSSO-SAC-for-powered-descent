...
run_dir_A = ("5_A_PER_2500", r"L2 loss")
run_dir_B = ("8_L1_loss", r"L1 loss")
...
plot_run_data(run_dir_B[0], 'red', '-', run_dir_B[1])
...
save_path = base_path + "/plots/l1_loss_comparison.png"
